...
if (str_starts_with($path, '/api/')) {
    ...
    if ($path === '/api/security.php') {
        ...
        echo json_encode([
            ...
            'mechanisms' => [
                ['key' => 'gateway', 'state' => 'active', 'title' => '订阅入口防护', 'detail' => 'Nginx 订阅路径规则已加载'],
                ...
                ['key' => 'ip_policy', 'state' => 'active', 'title' => 'IP 名单策略', 'detail' => '白名单 3 / 黑名单 24'],
                ['key' => 'ua_policy', 'state' => 'active', 'title' => 'UA 识别与策略', 'detail' => '放行 11 / 拦截 10'],
                ...
                ['key' => 'alerts', 'state' => 'optional', 'title' => '高危事件推送', 'detail' => '未启用（可选）'],
