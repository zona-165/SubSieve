...
define('CLOUD_PROVIDER_CATALOG_JSON', '/etc/nginx/subscribe/cloud_provider_catalog.json');
define('CLOUD_PROVIDER_SETTINGS_JSON', '/etc/nginx/subscribe/cloud_provider_settings.json');
define('CLOUD_PROVIDER_STATE_JSON', '/etc/nginx/subscribe/cloud_provider_state.json');
define('CLOUD_PROVIDER_STATUS_JSON', '/etc/nginx/subscribe/cloud_provider_status.json');
define('CLOUD_PROVIDER_REFRESH_SIGNAL', '/etc/nginx/subscribe/.refresh_cloud_providers');
